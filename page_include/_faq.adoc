...
==== Why do multiple shells share the same history?

It is a feature of zsh. Oh-my-zsh has +INC_APPEND_HISTORY+ on as default.
To disable this put this in your .zshrc:
